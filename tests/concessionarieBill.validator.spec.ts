import ConcessionarieValidator from '../src/validators/concessionarieBill.validator'
...
describe('Test ConsseionarieBillValidator', () => {
	...
	describe('Test validateDigitsLineWithDVContent method', () => {
		test('should check DigitsLine content and return true', () => {
			expect(
				consseionarieBillValidator.validateDigitsLineContent(
					validDigitsLine,
	...
	describe('Test validateDigitsLineDV method', () => {
		...
		test('should invalidate digitsLine DV', () => {
			expect(consseionarieBillValidator.validateDigitsLineDV(differentDV)).not.toEqual(
				expect.objectContaining({
					isValid: true,
					barcode,
				})
